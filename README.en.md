...
3. Make sure `npm run ci` passes (lint + 160 tests)
...
**Electron 42.3.2** · **Chromium 148.0.7778.218** · **Node.js 24.15.0** · **Vanilla JS** · **Web Audio API** · **160 tests** · **GitHub Actions CI**
