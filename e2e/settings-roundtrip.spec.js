...
const PLAN = [
    ...
    // Фильтр отчёта о перелимите. Контрол строит panel-display.js в скрытой
    // секции «47-го этажа» — он в DOM и тогда, когда секция не видна, поэтому
    // сохранение проверяется без разблокировки. Значение — НЕ умолчание
    // (умолчание false), иначе сохранение нечем было бы отличить от забвения.
    { id: 'reportOnlyOverruns', kind: 'checkbox', value: true },
