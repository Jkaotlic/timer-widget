 ...
 */
const BASELINE = {
    'widget.circle.normal': { color: 'rgb(255, 255, 255)', textShadow: 'rgba(0, 0, 0, 0.5) 0px 2px 4px, rgba(10, 132, 255, 0.6) 0px 0px 20px' },
    'display.circle.normal': { color: 'rgb(255, 255, 255)', textShadow: 'rgba(0, 0, 0, 0.4) 0px 4px 8px, rgba(10, 132, 255, 0.55) 0px 0px 60px' },
    'widget.circle.warning': { color: 'rgb(255, 193, 7)', textShadow: 'rgba(0, 0, 0, 0.5) 0px 2px 4px, rgba(255, 193, 7, 0.6) 0px 0px 20px' },
    'display.circle.warning': { color: 'rgb(255, 193, 7)', textShadow: 'rgba(0, 0, 0, 0.4) 0px 4px 8px, rgba(255, 193, 7, 0.6) 0px 0px 60px' },
    'widget.circle.danger': { color: 'rgb(255, 68, 68)', textShadow: 'rgba(0, 0, 0, 0.5) 0px 2px 4px, rgba(255, 68, 68, 0.8) 0px 0px 20px' },
    'display.circle.danger': { color: 'rgb(255, 68, 68)', textShadow: 'rgba(0, 0, 0, 0.4) 0px 4px 8px, rgba(255, 68, 68, 0.7) 0px 0px 60px' },
    'widget.circle.overtime': { color: 'rgb(255, 68, 68)', textShadow: 'rgba(0, 0, 0, 0.5) 0px 2px 4px, rgba(255, 68, 68, 0.8) 0px 0px 20px' },
    'display.circle.overtime': { color: 'rgb(255, 68, 68)', textShadow: 'rgba(0, 0, 0, 0.4) 0px 4px 8px, rgba(255, 68, 68, 0.7) 0px 0px 60px' },
    'widget.digital.normal': { color: 'rgb(48, 209, 88)', textShadow: 'rgb(48, 209, 88) 0px 0px 10px, rgb(48, 209, 88) 0px 0px 20px, color(srgb 0.188235 0.819608 0.345098 / 0.4) 0px 0px 40px' },
    'display.digital.normal': { color: 'rgb(48, 209, 88)', textShadow: 'rgb(48, 209, 88) 0px 0px 20px, rgb(48, 209, 88) 0px 0px 40px, rgba(48, 209, 88, 0.4) 0px 0px 80px' },
    'widget.digital.warning': { color: 'rgb(255, 204, 0)', textShadow: 'rgb(255, 204, 0) 0px 0px 10px, rgb(255, 204, 0) 0px 0px 20px, rgba(255, 204, 0, 0.4) 0px 0px 40px' },
    'display.digital.warning': { color: 'rgb(255, 204, 0)', textShadow: 'rgb(255, 204, 0) 0px 0px 20px, rgb(255, 204, 0) 0px 0px 40px, rgba(255, 204, 0, 0.4) 0px 0px 80px' },
    'widget.digital.danger': { color: 'rgb(255, 51, 51)', textShadow: 'rgb(255, 51, 51) 0px 0px 10px, rgb(255, 51, 51) 0px 0px 20px, rgba(255, 51, 51, 0.4) 0px 0px 40px' },
    'display.digital.danger': { color: 'rgb(255, 51, 51)', textShadow: 'rgb(255, 51, 51) 0px 0px 20px, rgb(255, 51, 51) 0px 0px 40px, rgba(255, 51, 51, 0.4) 0px 0px 80px' },
    'widget.digital.overtime': { color: 'rgb(255, 51, 51)', textShadow: 'rgb(255, 51, 51) 0px 0px 10px, rgb(255, 51, 51) 0px 0px 20px, rgba(255, 51, 51, 0.4) 0px 0px 40px' },
    'display.digital.overtime': { color: 'rgb(255, 51, 51)', textShadow: 'rgb(255, 51, 51) 0px 0px 20px, rgb(255, 51, 51) 0px 0px 40px, rgba(255, 51, 51, 0.4) 0px 0px 80px' },
    ...
    'widget.analog.normal': { color: 'rgba(255, 255, 255, 0.58)', textShadow: 'rgba(10, 132, 255, 0.3) 0px 0px 10px' },
    'display.analog.normal': { color: 'rgba(255, 255, 255, 0.78)', textShadow: 'rgba(0, 0, 0, 0.5) 0px 2px 8px' },
    'widget.analog.warning': { color: 'rgba(255, 255, 255, 0.58)', textShadow: 'rgba(10, 132, 255, 0.3) 0px 0px 10px' },
    'display.analog.warning': { color: 'rgb(255, 193, 7)', textShadow: 'rgba(0, 0, 0, 0.5) 0px 2px 8px' },
    'widget.analog.danger': { color: 'rgba(255, 69, 58, 0.7)', textShadow: 'rgba(255, 69, 58, 0.5) 0px 0px 10px' },
    'display.analog.danger': { color: 'rgb(255, 68, 68)', textShadow: 'rgba(0, 0, 0, 0.5) 0px 2px 8px' },
    'widget.analog.overtime': { color: 'rgba(255, 69, 58, 0.7)', textShadow: 'rgba(255, 69, 58, 0.5) 0px 0px 10px' },
