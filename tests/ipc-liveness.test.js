 ...
 *
 * Списки каналов (SENDERS/RECEIVERS в `ipc-senders.js`, из них — мосты окон
 * и `channel-validator.js`) могут содержать и канал, которого больше нет ни у
 * кого: список — это разрешение, а не признак жизни. В проекте нашлись сразу три таких места:
 *
