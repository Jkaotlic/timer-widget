...
test('значение блока в «Цифрах» набирается ЦВЕТОМ ТЕКСТА, а не зелёным табло', () => {
    ...
    //
    // Причина у обоих одна — остаток стиля LED. Сначала (26.08.2026) был
    // снят зелёный у ЗНАЧЕНИЯ, следом, по второй просьбе, и у подписи:
    ...
    // Подпись здесь НЕ проверяется: 26.08.2026 зелёная подпись «Цифр» тоже
    // отменена, и у стиля своей перебивки не осталось вовсе — он наследует
