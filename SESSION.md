...
- **786 unit, 177 e2e**, lint чистый. НЕ закоммичено (в дереве лежит и прошлая
  сессия про раскладки дисплея).
- Полный e2e даёт ОДИН плавающий провал за прогон (`ui-pass` — таймаут 30s на
  «кольцо дисплея в центре»); в одиночку проходит. Профиль общий на прогон.
...
1. Коммит: одним или разбить по темам (тон / блоки / раскладки / аналог), и
   пересобирать ли эталоны скриншотов до или после.
...
3. Плавающий провал e2e — закрыть отдельно.
