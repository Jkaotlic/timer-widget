...
const CONFIG = {
    ...
    // Пол высоты для стиля LED: окно там не квадрат, а полоса по размеру цифр
    // (ledStripHeight в window-geometry.js). Общий пол в 140 px делал полосу
    // недостижимой — запрошенные ~90 px поджимались обратно, и рамка снова
    // оказывалась в пустой тёмной коробке, с чего вся правка и началась.
    // Значение ниже самой узкой полосы: при минимальной ширине 120 и строке
    // H:MM:SS со знаком она составляет 31 px.
    WIDGET_LED_MIN_HEIGHT: 28,
