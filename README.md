...
- **Ctrl + зажать** — слайдер масштабирования 30–600%
...
Зажмите `Ctrl` — появится слайдер масштабирования (30–600%). Работает на виджете, часах и полноэкранном дисплее.
...
- Ctrl+slider масштабирование 30–600%
