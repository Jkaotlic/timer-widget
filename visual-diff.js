...
//   light-clock          — тот же виджет часов, снятый в светлой теме. Имя не
//                          начинается с `clock-`, поэтому под общее правило не
//                          попадает и нуждается в отдельной строке.
//
